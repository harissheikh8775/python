    ...
    if drink == "report":
        ...
        if water < water_needed(MENU, drink):
            ...
            if finaltotal > drink_cost(MENU, drink):
                changefor_customer = customer_change(
                    customer_deposit(quarter, dime, nickel, penny),
                    drink_cost(MENU, drink),
                )
                ...
                print(
                    f"Thank you for giving the exact amount! Here is your {drink}. Enjoy!"
                )

            # Check remaining resources
            remaining_resources(
                resources,
                water_needed(MENU, drink),
                coffee_needed(MENU, drink),
                milk_needed(MENU, drink),
            )
